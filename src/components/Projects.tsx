            ...
            <div className='projects'>
                ...
                <div className="project">
                    <div className={theme === 'dark' ?'photo':'photo light'}>
                        <img src="./img/project-pos.png" alt="project 1" />
                    </div>
                    ...
                    <div className="description">
                        ...
                        <p>A full stack Point of Sale (POS) system built with NestJS, TypeORM, and Next.js, 
                            focused on real-world business logic and scalable architecture</p>

                        <div className="pj-buttons">
                            <a href="https://pos-front-beta.vercel.app/" target="_blank" rel="noopener noreferrer" className="pj-btn">
                                <img src="./img/eye-white.png" alt="eye icon" />
                                <span>Preview</span>
                            </a>
                            <a href="https://github.com/wilmed10/pos-nest" target="_blank" rel="noopener noreferrer" className="pj-btn">
                ...
                <div className="project midle">
                    <div className={theme === 'dark' ?'photo':'photo light'}>
                        <img src="./img/project-drinks.png" alt="project 2" />
                    </div>
                    ...
                    <div className="description">
                        ...
                        <p>Built with React, Zustand, and React Router DOM. 
                            Integrated external APIs for dynamic recipe searches and implemented an LLM with openrouter/ai-sdkprovider for recipe queries.</p>
                ...
                <div className="project">
                    <div className={theme === 'dark' ?'photo':'photo light'}>
                        <img src="./img/project-pern.png" alt="project 3" />
                    </div>
                    ...
                    <div className="description">
                        ...
                        <p>Developed a full stack application with PostgreSQL, Express, React, and Node.js. 
                            Built a REST API with testing and documentation, and connected it to a React frontend.</p>
